...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_tabs', type=int, default=5)
    parser.add_argument('--data_path', type=str, default = '/home/wuzr/feverous/data')
    ...
    #in_path_tabs = '{0}/{1}.rc.p5.t3.jsonl'.format(args.data_path, split)
    in_path_tabs = '{0}/{1}.rc.p5.t10.jsonl'.format(args.data_path, split)
    tabs_pred = {}
    print(in_path_tabs)
    ...
    out_path = '{0}/{1}.roberta_sent.rc_table.not_precomputed.p{2}.s{3}.t{4}.jsonl'.format(args.data_path, split, args.max_page, args.max_sent, args.max_tabs)
    print(out_path)
        ...
        with jsonlines.open("{0}/{1}.jsonl".format(args.data_path, args.split)) as f:
            for i,line in enumerate(f.iter()):
                ...
                if line['id'] not in tabs_pred:
                    ...
                    predicted_tables = tabs_pred[line['id']][:args.max_tabs]
