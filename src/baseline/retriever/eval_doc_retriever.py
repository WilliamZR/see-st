...
def page_coverage(args):
    ...
    #args.input_path = '/home/hunan/feverous/mycode/data/train.sentences.not_precomputed.p5.s10.jsonl'
    #args.input_path = "data/dev.tables.not_precomputed.p5.t3.jsonl"
    ...
    #wargs.input_path = '/home/hunan/feverous/mycode/data/dev.combined.not_precomputed.p5.s5.t3.jsonl'
    #args.input_path = '/home/hunan/feverous/mycode/data/{}.tapas.reranker.p5.s5.jsonl'
    #args.input_path = '/home/hunan/feverous/mycode/data/dev.pages.refined_claim.s1.t1.150.jsonl'
    #args.input_path = '/home/hunan/feverous/mycode/data/dev.pages.combined_refined.p10.jsonl'
...
def page_coverage_obj(args, data, max_predicted_pages = 150):
    ...
    coverage = []
    coverage_all = []
    in_path = '/home/hunan/feverous/mycode/data/{}.jsonl'.format(args.split)
    annotation_processor = AnnotationProcessor(in_path)
    annotation_by_id = {el.get_id(): el for el in annotation_processor}
