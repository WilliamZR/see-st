...
def model_trainer(model_path, train_dataset, test_dataset):
    ...
    model = RobertaForTokenClassification.from_pretrained('/home/hunan/bert_weights/roberta-base'
...
def claim_hypothesis_only_bias(annotations_train, annotations_dev, args):
    ...
    tokenizer = AutoTokenizer.from_pretrained('/home/hunan/bert_weights/roberta-base'
