...
def get_parser():
    ...
    parser.add_argument('--num_workers', type=int, default=2, help='Number of workers in the dataloader.')

    parser.add_argument('--wiki_path', type=str, default="/home/hunan/feverous/mycode/data/feverous_wikiv1.db", help='/path/to/data')
    parser.add_argument('--train_data_type', type=str, help="gold, retrieved, both", default='fusion')
