...
def main():
    ...
    # data_generator = getattr(data_generators, args.data_generator)
    ...
    train_data, valid_data, test_data = preprocessor.process(
        args.data_dir, args.cache_dir, data_generator, args.tokenizer, dataset=["dev", "train"])
